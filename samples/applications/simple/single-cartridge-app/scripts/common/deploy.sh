...
curl -X POST -H "Content-Type: application/json" -d "@${artifacts_path}/application1.json" -k -v -u admin:admin https://${host_ip}:${host_port}/api/applications
curl -X POST -H "Content-Type: application/json" -d "@${artifacts_path}/app.json" -k -v -u admin:admin https://${host_ip}:${host_port}/api/applications
sleep 1
